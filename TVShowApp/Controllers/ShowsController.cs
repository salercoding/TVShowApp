...
namespace TVShowApp.Controllers
{
    public class ShowsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ShowTitle,ShowDescription")] Show show)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ShowTitle,ShowDescription")] Show show)
        {
            if (id != show.Id)
            {
                return NotFound();
